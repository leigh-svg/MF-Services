...
export function ETS64RDiagram({ system, componentStates }) {
  ...
  return (
    <div style={{ width: "100%", overflow: "hidden", minHeight: 280 }}>
      <svg viewBox="0 0 760 320" preserveAspectRatio="xMidYMid meet" width="100%" height="auto" style={{ maxWidth: 800, margin: "0 auto" }} role="img" aria-label="ETS 64-R Single Leaf Fire Door System Diagram">
      ...
      <line x1="464" y1="75" x2="480" y2="75" stroke="#1470B1" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#cableArrow)" />
      <line x1="464" y1="155" x2="480" y2="155" stroke="#1470B1" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#cableArrow)" />
      <line x1="464" y1="240" x2="480" y2="240" stroke="#1470B1" strokeWidth="1.5" strokeDasharray="4 3" markerEnd="url(#cableArrow)" />
      ...
      {/* COMPONENT CIRCLES */}
      {/* 1 — PWR (Mandatory) */}
      <circle cx="165" cy="45" r="18" fill="none" stroke="#ED6E02" strokeWidth="2.5" />
      <text x="165" y="50" textAnchor="middle" fontSize="12" fontWeight="700" fill="#00387B" fontFamily="monospace">1</text>
      <text x="165" y="68" textAnchor="middle" fontSize="10" fontWeight="600" fill="#00387B" fontFamily="sans-serif">PWR</text>

      {/* 2 — EOP (Mandatory) */}
      <circle cx="480" cy="75" r="18" fill="none" stroke="#ED6E02" strokeWidth="2.5" />
      <text x="480" y="80" textAnchor="middle" fontSize="12" fontWeight="700" fill="#00387B" fontFamily="monospace">2</text>
      <text x="480" y="98" textAnchor="middle" fontSize="10" fontWeight="600" fill="#00387B" fontFamily="sans-serif">EOP</text>

      {/* 3 — BLT (Mandatory) */}
      <circle cx="480" cy="155" r="18" fill="none" stroke="#ED6E02" strokeWidth="2.5" />
      <text x="480" y="160" textAnchor="middle" fontSize="12" fontWeight="700" fill="#00387B" fontFamily="monospace">3</text>
      <text x="480" y="178" textAnchor="middle" fontSize="10" fontWeight="600" fill="#00387B" fontFamily="sans-serif">BLT</text>

      {/* 5 — SNS (Mandatory) */}
      <circle cx="165" cy="170" r="18" fill="none" stroke="#ED6E02" strokeWidth="2.5" />
      <text x="165" y="175" textAnchor="middle" fontSize="12" fontWeight="700" fill="#00387B" fontFamily="monospace">5</text>
      <text x="165" y="193" textAnchor="middle" fontSize="10" fontWeight="600" fill="#00387B" fontFamily="sans-serif">SNS</text>

      {/* 5.1 — SUB (Optional) */}
      <circle cx="165" cy="230" r="16" fill="none" stroke="#1470B1" strokeWidth="2.5" />
      <text x="165" y="235" textAnchor="middle" fontSize="11" fontWeight="700" fill="#1470B1" fontFamily="monospace">5.1</text>
      <text x="165" y="251" textAnchor="middle" fontSize="9" fontWeight="600" fill="#1470B1" fontFamily="sans-serif">SUB</text>

      {/* 9 — PRG (Optional) */}
      <circle cx="480" cy="240" r="18" fill="none" stroke="#1470B1" strokeWidth="2.5" />
      <text x="480" y="245" textAnchor="middle" fontSize="12" fontWeight="700" fill="#1470B1" fontFamily="monospace">9</text>
      <text x="480" y="263" textAnchor="middle" fontSize="10" fontWeight="600" fill="#1470B1" fontFamily="sans-serif">PRG</text>

      {/* MRB FIRE (Mandatory) */}
      <circle cx="165" cy="285" r="18" fill="none" stroke="#ED6E02" strokeWidth="2.5" />
      <text x="165" y="287" textAnchor="middle" fontSize="11" fontWeight="700" fill="#ED6E02" fontFamily="sans-serif">MRB</text>
      <text x="165" y="300" textAnchor="middle" fontSize="9" fontWeight="600" fill="#ED6E02" fontFamily="sans-serif">FIRE</text>
